...
public class Holidays {
    ...
    public static Integer calculateHolidays(String startDate, String endDate, Integer salary) {
        ...
        return (salary * (int) ChronoUnit.DAYS.between(startDates, endDates)) / 720;
